...
# ----- Botón interactivo -----
st.markdown("## 😘 Un detalle más...")

if st.button("Dame un beso, mudoso 💋"):
    st.markdown("<h2 style='text-align: center; color: pink;'>Muak muak muak 💕 Te amo, mi mudosa hermosa</h2>", unsafe_allow_html=True)
    st.balloons()
